  ...
  return (
    <section className="relative mb-24">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12">
        ...
        <Link href={`/blog/${featuredPost.id}`} className="lg:col-span-7 group">
          <motion.div
            initial={{ opacity: 0, x: -20 }}
            animate={{ opacity: 1, x: 0 }}
            className="h-full"
          >
            <div className="relative aspect-video lg:aspect-square xl:aspect-video rounded-[32px] overflow-hidden mb-8 shadow-2xl">
              <Image
        ...
        <div className="lg:col-span-5 flex flex-col gap-10">
          ...
          {secondaryPosts.map((post, idx) => (
            <Link href={`/blog/${post.id}`} key={post.id}>
              ...
              >
                <div className="relative w-28 h-28 md:w-32 md:h-32 shrink-0 rounded-4xl overflow-hidden shadow-2xl">
                  <Image
                    src={post.image}
