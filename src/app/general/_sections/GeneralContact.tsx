                ...
                >
                    ...
                    <div className="relative bg-zinc-950/80 backdrop-blur-3xl rounded-[4rem] px-6 py-12 md:px-20 md:py-24 flex flex-col items-center text-center border border-white/10">
                        ...
                        >
                            ...
                            <div className="relative w-24 h-24 rounded-3xl bg-linear-to-b from-white/10 to-transparent border border-white/20 flex items-center justify-center backdrop-blur-md">
                        ...
                        <div className="space-y-6 max-w-4xl">
                            <motion.h2
                                ...
                                className="section-title text-4xl md:text-6xl font-black text-white leading-tight"
                            >
                                {t('title')}
                            </motion.h2>
                            <motion.p
