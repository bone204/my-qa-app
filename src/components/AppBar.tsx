...
export default function AppBar() {
  ...
  return (
    <header
      className={`fixed top-0 z-50 w-full px-4 py-4 md:px-8 transition-all duration-300 ease-in-out ${isVisible ? "translate-y-0" : "-translate-y-full"} ${isScrolled ? "bg-white/70 backdrop-blur-md shadow-sm" : "bg-transparent"}`}
    >
