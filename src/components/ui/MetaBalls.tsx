...
const MetaBalls = ({
  ...
  useEffect(() => {
    ...
    const renderer = new Renderer({ dpr: window.devicePixelRatio || 1, alpha: true, premultipliedAlpha: false });
    ...
    function onPointerMove(e: PointerEvent) {
      ...
      // Convert to absolute pixel coordinates matching iResolution
      pointerX = px * (gl.canvas.width / rect.width);
      pointerY = (rect.height - py) * (gl.canvas.height / rect.height);
    }
