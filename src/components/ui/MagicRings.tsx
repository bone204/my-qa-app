...
void main() {
  ...
  gl_Color = vec4(c, max(c.r, max(c.g, c.b)) * uOpacity);
}
`;

// Fragment shader fix: use gl_FragColor for WebGL
const fixedFragmentShader = fragmentShader.replace("gl_Color =", "gl_FragColor =");
...
export default function MagicRings({
  ...
  useEffect(() => {
    ...
    const material = new THREE.ShaderMaterial({ 
      vertexShader, 
      fragmentShader: fixedFragmentShader, 
      uniforms, 
      transparent: true 
    });
