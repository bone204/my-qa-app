    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col gap-4 p-6 flex-1">
                {/* Tag */}
                <span className={`w-fit text-[11px] font-black uppercase tracking-widest px-3 py-1 rounded-full border ${tagColors[post.tag[locale]] ?? "text-zinc-400 bg-white/5 border-white/10"}`}>
                    {post.tag[locale]}
                </span>
